...
INSERT INTO `administrator` VALUES (1,'admin','Darryl Hyatt','$2y$12$AaLmGgycH.5Lzw2k3gTer.fOElwqfUH6TWpNtm6y2b.1zodkZpkUu','admin','2023-12-25 14:00:34','2023-12-25 14:00:34'),(2,'admin2','Administrator 2','$2y$12$AaLmGgycH.5Lzw2k3gTer.fOElwqfUH6TWpNtm6y2b.1zodkZpkUu','admin',NULL,NULL),(5,'warek_1','Wakil Rektor 1 Password','$2y$12$AaLmGgycH.5Lzw2k3gTer.fOElwqfUH6TWpNtm6y2b.1zodkZpkUu','warek',NULL,'2023-12-25 15:10:16');
...
INSERT INTO `ketua_kelompok` VALUES (1,2,'1903015985','$2y$12$sYTqINxk0/YHoylVHFguhuV0VpVpG/mqfFMuXykW4qEhyokzA03tC',NULL,NULL);
...
INSERT INTO `peninjau` VALUES (1,1,'648929164','$2y$12$vGTO2HaREUox7FKbOXv4b.IRmAx6/T74iL9bjyb/86dAmBaq9B5ou',NULL,NULL);
...
CREATE TABLE `usulan` (
  ...
  CONSTRAINT `usulan_FK_peninjau_id` FOREIGN KEY (`peninjau_id`) REFERENCES `data_dosen` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
...
-- Dump completed on 2024-01-07 11:59:05
