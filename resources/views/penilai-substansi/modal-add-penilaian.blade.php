        ...
        <div class="modal-body">
            ...
            <form action="{{route('penilai-substansi.penilaian.tambah-penilaian', $detail->id)}}" enctype="multipart/form-data" name="form-tambah-penilaian" method="POST">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="file" name="form_penilaian_substansi" id="formFile" />
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                            ...
                            <label class="btn btn-outline-danger" for="status_penilaian1">Minor</label>

                            <input type="radio" class="btn-check" value='mayor' name="status_penilaian" id="status_penilaian2" />
                            <label class="btn btn-outline-success" for="status_penilaian2">Mayor</label>
                        </div>
                    </div>
                </div>
            </form>
