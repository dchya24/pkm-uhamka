        ...
        <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
          <div class="container-xxl">
            <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
              <a href="{{route('reviewer.dashboard')}}" class="app-brand-link gap-2">
                <img src="{{asset('assets/img/Logo/uhamka.png')}}" alt class="w-px-40 h-auto rounded-circle" />
                ...
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-2 me-xl-1">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end py-0">
                    ...
                    <li class="dropdown-notifications-list scrollable-container">
                      <ul class="list-group list-group-flush">
                        @forelse(session()->get('session_informasi') as $informasi)
                          <a href="{{route('reviewer.informasi')}}" class="">
                    ...
                    <li class="dropdown-menu-footer border-top p-2">
                      <a href="{{route('reviewer.informasi')}}" class="btn btn-primary d-flex justify-content-center">
                      ...
                      <a class="dropdown-item" href="M_Akunsaya.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-medium d-block">{{{Auth::guard('peninjau')->user()->dosen->nama}}}</span>
                            <small class="text-muted">Peninjau</small>
                          </div>
                        </div>
                      </a>
                    </li>
