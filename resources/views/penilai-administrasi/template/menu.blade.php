    ...
    <div class="container-xxl d-flex h-100">
      <ul class="menu-inner">
        ...
        <li class="menu-item active">
          <a class="menu-link" href="/P_Administrasi/A_Dashboard.html">
        ...
        <!-- Informasi -->
        <li class="menu-item">
          <a class="menu-link" href="/P_Administrasi/A_Informasi.html">
        ...
        <!-- Penilaian Proposal -->
        <li class="menu-item">
          <a href="/P_Administrasi/A_Penilaian.html" class="menu-link">
        ...
        <!-- Tentang Akun -->
        <li class="menu-item">
          <a href="/P_Administrasi/A_Akunsaya.html" class="menu-link">
