  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
      <div class="card-header">
        ...
        <h3 class="text-center pt-3">Penambahan Wakil Rektor pada Usulan </h3>                 
          <Label>Nama Wakil Rektor : {{$warek->nama}} </Label>
          <br>
          <label for="">Jumlah Usulan yang dinilai : {{$warek->usulan->count()}}</label>
          <br>
            ...
            <tbody>
              @forelse ($warek->usulan as $item)
                <tr>
                  ...
                  <td>
                    <form action="{{route('admin.manajemen-proposal.wakil-rektor.delete-warek', $item->id)}}" method="POST">
                      @csrf
                      @method('DELETE')
