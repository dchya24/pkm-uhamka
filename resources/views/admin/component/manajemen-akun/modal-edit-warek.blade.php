  ...
  <div class="modal fade" id="modal-edit-warek" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-4">
            <div class="card-body">
              <form action="{{ route('admin.manajemen-akun.wakil-rektor.update', 100) }}" method="POST" name="edit_warek" id="edit_warek">
